...
public class DefaultHttpClientBuilder implements HttpClientBuilder {
    protected final Logger log = LoggerFactory.getLogger(DefaultHttpClientBuilder.class);
    ...
    public static DefaultHttpClientBuilder get() {
        return DefaultHttpClientBuilder.SingletonHolder.INSTANCE;
    }
    ...
    private static class SingletonHolder {
        private static final DefaultHttpClientBuilder INSTANCE = new DefaultHttpClientBuilder();
    }
