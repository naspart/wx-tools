...
public interface WxMaQrcodeService {
     ...
     * @throws WxErrorException 异常
     */
    byte[] createWxaCodeBytes(String path, int width, boolean autoColor, WxMaQrcodeLineColor lineColor, boolean isHyaline)
     ...
     * @throws WxErrorException 异常
     */
    File createWxaCode(String path, int width, boolean autoColor, WxMaQrcodeLineColor lineColor, boolean isHyaline)
            throws WxErrorException;
