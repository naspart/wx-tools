...
import com.naspat.pay.api.PayScoreService;
import com.naspat.pay.api.WxPayService;
import com.naspat.pay.bean.SignatureHeader;
import com.naspat.pay.bean.payscore.PayScoreNotifyData;
import com.naspat.pay.bean.payscore.UserAuthorizationStatusNotifyResult;
import com.naspat.pay.bean.payscore.WxPayScoreRequest;
import com.naspat.pay.bean.payscore.WxPayScoreResult;
import com.naspat.pay.config.WxPayConfig;
import com.naspat.pay.exception.WxPayException;
import com.naspat.pay.v3.util.AesUtils;
...
public class PayScoreServiceImpl implements PayScoreService {
    ...
    public WxPayScoreResult permissions(WxPayScoreRequest request) throws WxPayException {
        WxPayConfig config = this.payService.getWxPayConfig();
    ...
    public UserAuthorizationStatusNotifyResult parseUserAuthorizationStatusNotifyResult(String notifyData, SignatureHeader header) throws WxPayException {
        ...
        String apiV3Key = this.payService.getWxPayConfig().getApiV3Key();
        try {
    ...
    private boolean verifyNotifySign(SignatureHeader header, String data) {
        ...
        return payService.getWxPayConfig().getVerifier().verify(header.getSerialNo(),
