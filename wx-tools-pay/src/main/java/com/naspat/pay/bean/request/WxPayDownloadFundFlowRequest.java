...
public class WxPayDownloadFundFlowRequest extends BaseWxPayRequest {
    private static final long serialVersionUID = 6496670938373227160L;
    private static final String[] ACCOUNT_TYPES = new String[]{WxPayConstants.AccountType.BASIC, WxPayConstants.AccountType.OPERATION, WxPayConstants.AccountType.FEES};
