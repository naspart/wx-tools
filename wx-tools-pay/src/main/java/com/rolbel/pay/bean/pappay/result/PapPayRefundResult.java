...
import com.rolbel.pay.bean.result.WxPayRefundCouponInfo;
...
@NoArgsConstructor
@XStreamAlias("xml")
public class PapPayRefundResult extends BaseWxPayResult {
    private static final long serialVersionUID = 5552552491373665244L;
