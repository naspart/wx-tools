package com.naspat.cp.api;

import com.naspat.common.bean.WxJsapiSignature;
import com.naspat.common.error.WxErrorException;
import com.naspat.common.session.WxSession;
...
public interface WxCpService {
   ...
   * WxCpService默认使用的是{@link com.naspat.common.session.StandardSessionManager}
   * </pre>
   *
