...
import com.naspat.cp.util.crypto.WxCpCryptUtil;
import com.naspat.cp.util.json.WxCpGsonBuilder;
import com.naspat.cp.util.xml.XStreamTransformer;
...
public class WxCpXmlMessage implements Serializable {
    private static final long serialVersionUID = -3617076417746975496L;
     ...
     * <pre>
     * 当接受用户消息时，可能会获得以下值：
     * {@link WxConstant.XmlMsgType#TEXT}
     * {@link WxConstant.XmlMsgType#IMAGE}
     * {@link WxConstant.XmlMsgType#VOICE}
     * {@link WxConstant.XmlMsgType#VIDEO}
     * {@link WxConstant.XmlMsgType#LOCATION}
     * {@link WxConstant.XmlMsgType#LINK}
     * {@link WxConstant.XmlMsgType#EVENT}
     * </pre>
     */
     ...
     * {@link WxConstant.XmlMsgType#VOICE}
     * {@link WxConstant.XmlMsgType#VIDEO}
     * {@link WxConstant.XmlMsgType#NEWS}
     * </pre>
     */
