...
public class WxMpDataCubeArticleTotal extends WxMpDataCubeBaseResult {
    ...
    public static List<WxMpDataCubeArticleTotal> fromJson(String json) {
        return WxMpGsonBuilder.create().fromJson(
                JSON_PARSER.parse(json).getAsJsonObject().get("list"),
                new TypeToken<List<WxMpDataCubeArticleTotal>>() {
                }.getType());
    }
}
