...
public class WxMpDataCubeArticleResult extends WxMpDataCubeBaseResult {
    ...
    public static List<WxMpDataCubeArticleResult> fromJson(String json) {
        return WxMpGsonBuilder.create().fromJson(
                JSON_PARSER.parse(json).getAsJsonObject().get("list"),
                new TypeToken<List<WxMpDataCubeArticleResult>>() {
                }.getType());
    }
}
