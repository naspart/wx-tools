...
public interface WxMpKefuService {
    ...
    String KF_ACCOUNT_ADD = "https://api.weixin.qq.com/customservice/kfaccount/add";
    String KF_ACCOUNT_UPDATE = "https://api.weixin.qq.com/customservice/kfaccount/update";
    String KF_ACCOUNT_INVITE_WORKER = "https://api.weixin.qq.com/customservice/kfaccount/inviteworker";
    String KF_ACCOUNT_UPLOAD_HEAD_IMG = "https://api.weixin.qq.com/customservice/kfaccount/uploadheadimg?kf_account=%s";
    String KF_ACCOUNT_DEL = "https://api.weixin.qq.com/customservice/kfaccount/del?kf_account=%s";
    String KF_SESSION_CREATE = "https://api.weixin.qq.com/customservice/kfsession/create";
    String KF_SESSION_CLOSE = "https://api.weixin.qq.com/customservice/kfsession/close";
